...
const _1672_Richest_Customer_Wealth_1 = require("../../../src/Array-101/1672-Richest-Customer-Wealth");
describe("1672. Richest Customer Wealth", () => {
    it("Input: [[1,2,3],[3,2,1]] - Output: 6", () => {
        const result = _1672_Richest_Customer_Wealth_1.maximumWealth.call(null, [
            [1, 2, 3],
            [3, 2, 1],
        ]);
